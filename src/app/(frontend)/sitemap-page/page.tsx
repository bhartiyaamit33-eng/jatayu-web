  ...
  return (
    <div className="border-b border-indigo/10 bg-white pb-[var(--section-y)] pt-28">
      <div className="container-page">
        {/* Narrative header stays narrow for readability. */}
        ...
        {/* Three columns side-by-side fill the page far better than stacked sections. */}
        <div className="mt-12 grid gap-12 lg:grid-cols-3">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-navy">Collections</h2>
            <ul className="mt-4 space-y-2 text-sm">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-navy">Other</h2>
            <ul className="mt-4 space-y-2 text-sm">
              {extras.map((e) => (
                <li key={e.href}>
